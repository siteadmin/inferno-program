...
module Inferno
  module Sequence
    class USCore311ResprateSequence < SequenceBase
      ...
      test :validate_resources do
        ...
        bindings = USCore311ResprateSequenceDefinitions::BINDINGS
      ...
      test 'All must support elements are provided in the Observation resources returned.' do
        ...
        skip_if_not_found(resource_type: 'Observation', delayed: false)
        must_supports = USCore311ResprateSequenceDefinitions::MUST_SUPPORTS
