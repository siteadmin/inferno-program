    ...
    class USCore311ImplantableDeviceSequence < SequenceBase
      ...
      test :search_by_patient do
        ...
        patient_ids.each do |patient|
          ...
          reply = get_resource_by_params(versioned_resource_class('Device'), search_params, search_method: :post)
          assert_response_ok(reply)
          assert_bundle_response(reply)
      ...
      test :validate_resources do
        ...
        bindings = USCore311ImplantableDeviceSequenceDefinitions::BINDINGS
