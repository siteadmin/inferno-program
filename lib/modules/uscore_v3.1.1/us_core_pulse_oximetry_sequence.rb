...
module Inferno
  module Sequence
    class USCore311PulseOximetrySequence < SequenceBase
      ...
      test :validate_resources do
        ...
        bindings = USCore311PulseOximetrySequenceDefinitions::BINDINGS
      ...
      test 'All must support elements are provided in the Observation resources returned.' do
        ...
        skip_if_not_found(resource_type: 'Observation', delayed: false)
        must_supports = USCore311PulseOximetrySequenceDefinitions::MUST_SUPPORTS
